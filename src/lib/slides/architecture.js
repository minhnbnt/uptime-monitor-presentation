export const architecture = [
  ...
  },
  {
    ...
    items: [
      ...
      { icon: 'k8', name: 'Kubernetes', desc: 'Chạy toàn bộ service trên nền Talos Linux (immutable, không SSH); ping-service truy vấn server/container status qua client-go' },
  ...
  },
  {
    ...
    cards: [
      ...
      { icon: '📡', title: 'ping-service', desc: 'Check trạng thái server/container qua client-go, điều độ ZSET' },
